...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JednostkaAdministracyjna.typ'
        db.alter_column(u'teryt_jednostkaadministracyjna', 'typ', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'JednostkaAdministracyjna.typ'
        db.alter_column(u'teryt_jednostkaadministracyjna', 'typ', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
    ...
    models = {
        u'teryt.jednostkaadministracyjna': {
            ...
            'typ': ('django.db.models.fields.CharField', [], {'max_length': '3'})
        },
        u'teryt.miejscowosc': {
